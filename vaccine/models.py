...
class Patient(models.Model):
    ...
    gender = models.CharField(max_length=50, choices=Gender.choices(), default=Gender.F)
    race = models.CharField(max_length=50, choices=Race.choices(), default=Race.X)
    ethnicity = models.CharField(max_length=50, choices=Ethnicity.choices(), default=Ethnicity.X)
